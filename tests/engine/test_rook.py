...
from pichess.engine.pieces import Rook
...
class TestRook(TestCase):
    ...
    def test_pseudolegal_coordinates(self):
        ...
        data = [
            ...
            ['h1', True, fen['5'], set()],
            ['a1', True, fen['7'], {'b1', 'c1'}],
            ['f3', True, fen['9'], {'a3', 'b3', 'c3', 'd3', 'e3', 'g3', 'f2'}],
            ['a3', False, fen['2'], {'b3', 'c3', 'd3', 'e3', 'f3', 'g3', 'a1', 'a2', 'a4', 'a5'}],
            ['h8', False, fen['4'], {'h5', 'h6', 'h7'}],
            ['c8', False, fen['6'], {'a8', 'b8', 'd8', 'e8', 'c5', 'c6', 'c7'}],
            ['a8', False, fen['8'], {'b8', 'c8', 'd8'}],
            ['h8', False, fen['10'], {'h7'}]
        ]
